...
module.exports = {
  forbidden: [
    ...
    {
      name: "not-to-s3-client",
      severity: "error",
      from: {
        pathNot: ["^src/dataAccess/s3.ts", "^src/types.ts"],
      },
      to: {
    ...
    },
    {
      ...
      to: {
        path: ["^src/dataAccess/prisma", "/@prisma/client"],
      },
    },
    {
      name: "not-to-api",
...
// generated: dependency-cruiser@16.0.0 on 2024-01-04T12:53:13.728Z
